...
```{r fastqc-gc, fig.width = 5, fig.height = 5}
# Fastqc GC result
head(gc_test_data, 4)
...
```{r fastqc-reads-quality, fig.width = 5, fig.height = 5}
...
```{r exp-box, fig.width = 5, fig.height = 5}
# expression matrix
...
```{r exp-pca, fig.width = 5, fig.height = 5}
...
```{r reads-cov, warning=F, fig.width = 5, fig.height = 5}
...
```{r var-por, warning=F, fig.width=5, fig.height=5}
