...
```{r theme_onmath, message=F, warning=F, fig.width = 4, fig.height = 3}
library(omplotr)
...
```{r fastqc-gc, fig.width = 4, fig.height = 3}
# Fastqc GC result
head(gc_test_data, 4)
...
```{r fastqc-reads-quality, fig.width = 4, fig.height = 3}
...
```{r exp-box, fig.width = 4, fig.height = 3}
# expression matrix
...
```{r exp-pca, fig.width = 4, fig.height = 3}
...
```{r exp-volcano-single, fig.width = 4, fig.height = 4}
# diff result
...
```{r reads-cov, warning=F, fig.width = 4, fig.height = 4}
...
```{r var-por, warning=F, fig.width=4, fig.height=4}
